...
const OwnerDashboard = () => {
  ...
  return (
    <div className='w-full min-h-screen bg-[#fff9f6] flex flex-col items-center'>
      ...
      <div className='flex items-center justify-center p-4 sm:p-6'>
       <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
        ...
        <h2 className='text-xl sm:text-2xl font-bold text-gray-800 mb-2'>
          Add Your Restaurant</h2>
          <p className='text-gray-600 mb-4 text-sm sm:text-base'>
            Join our food delivery platform and reach thousands 
            of hungry customers every day.</p>
     ...
     <div className='w-full flex flex-col items-center gap-6 px-4 sm:px-6'>
      <h1 className='text-2xl sm:text-3xl text-gray-900 flex items-center gap-3 mt-8 text-center'>
        <FaUtensils className='text-[#ff4d2d] w-14 h-14'/>
         ...
         <div className='bg-white rounded-xl shadow-lg overflow-hidden border border-orange-100 hover:shadow-2xl transition-all duration-300 w-full max-w-2xl relative'>
     ...
     {myShopData?.items?.length>0 && <div className='flex flex-col gap-4 items-center w-full max-w-3xl'>
