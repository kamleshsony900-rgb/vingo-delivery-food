...
const CategoryCard = ({name,image, onClick}) => {
  return (
    <div className='w-30 h-30 md:w-45 md:h-45 rounded-2xl border-2 border-[#ff4d2d] shrink-0 overflow-hidden bg-white shadow-2xl shadow-gray-200 hover:shadow-lg transition-shadow relative'
    onClick={onClick}>
